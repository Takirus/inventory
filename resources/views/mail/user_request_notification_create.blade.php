...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 10px 20px; margin-top: 15px; background: #007bff; color: #fff; text-decoration: none; border-radius: 5px; }
    </style>
</head>
<body>
    <div class="container">
        <h2>Новая заявка создана</h2>
        <p>Здравствуйте, <strong>{{ $request->user->name }}</strong>! Вами была создана новая заявка на портале "Inventory".</p>
        ...
        <p>Если Вы не создавали данную заявку - просто проигнорируйте данное письмо.</p>
    </div>
</body>
</html>
